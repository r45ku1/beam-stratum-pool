...
let u2 = require('util');
const bh = require('beamhashverify');
...
var JobManager = module.exports = function JobManager(options) {
	...
	if (this.currentJob.rpcData.height != job.rpcData.height) {
        ...
        if ((forkheight1 > 0) && (job.rpcData.height >= forkheight1)) {  // Beam Hash II
        	powType=1;
        }  
        if ((forkheight2 > 0) && (job.rpcData.height >= forkheight2)) { // Beam Hash III
        	powType=2;
        }   
